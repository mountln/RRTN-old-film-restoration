...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='rrtn', help='The name of adopted model')
    parser.add_argument('--discriminator_name', type=str, default='discriminator_v2', help='The name of adopted discriminator model')
    ...
    parser.add_argument('--flow_path', type=str, default='pretrained_models/raft-sintel.pth', help='the pretrainde model path of flow estimation')
    parser.add_argument('--num_recursion', type=int, default=1, help='The number of recursion steps during training, default to 1.')
